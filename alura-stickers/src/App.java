...
//				+ PROPRIEDADES.getProperty("imdb-api-key");
		...
		StickerFactory geradorDeFigurinhas = new StickerFactory("impact.ttf");
		for (Map<String, String> conteudo : listaDeFilmes) {
			...
			try (InputStream fluxoDeDados = new URL(urlImagem).openStream()) {

				geradorDeFigurinhas.gerar(fluxoDeDados, titulo, avaliacao);
