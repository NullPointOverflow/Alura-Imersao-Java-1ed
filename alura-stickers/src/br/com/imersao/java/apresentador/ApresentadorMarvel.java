...
public class ApresentadorMarvel implements ApresentadorDeConteudo {

	private InterfaceDeTexto controleDeTexto;

	public ApresentadorMarvel(InterfaceDeTexto controleDeTexto) {
	...
	public void apresentar(List<Conteudo> listaDeConteudos) {
		...
		for (int i = 0; i < listaDeConteudos.size(); i++) {
			...
			this.controleDeTexto.exibirTexto(EscapeANSI.FUNDO_VERMELHO.getEscapeCaracter()
					+ EscapeANSI.NEGRITO.getEscapeCaracter() + "Personagem:"
