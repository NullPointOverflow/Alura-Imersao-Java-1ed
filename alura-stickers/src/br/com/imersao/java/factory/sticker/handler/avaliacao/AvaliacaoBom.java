...
public class AvaliacaoBom implements AvaliacaoHandler, CalculadorDeImagem {
	...
	public AvaliacaoBom(AvaliacaoHandler proximoHandler) {

		this.proximoHandler = proximoHandler;

		this.avaliacao = Avaliacao.BOM;
