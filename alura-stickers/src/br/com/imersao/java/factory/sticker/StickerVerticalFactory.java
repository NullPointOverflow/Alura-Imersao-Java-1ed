...
public class StickerVerticalFactory {
	...
	public StickerVerticalFactory(Font fontePadrao) {
	...
	private void setFonteDeTextoDasFrases() {
		...
		this.fonteEstrelas = new Font(Font.SANS_SERIF, Font.BOLD, (int) (this.larguraDefinitiva * 0.161));

		this.fonteClassificacao = this.fontePadrao.deriveFont(Font.ITALIC, (int) (this.larguraDefinitiva * 0.15));

		this.fontePadrao = this.fontePadrao.deriveFont(Font.PLAIN, (int) (this.alturaDefinitiva * 0.06));
