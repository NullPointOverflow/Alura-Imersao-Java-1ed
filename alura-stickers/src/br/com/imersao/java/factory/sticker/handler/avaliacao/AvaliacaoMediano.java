...
public class AvaliacaoMediano implements AvaliacaoHandler, CalculadorDeImagem {
	...
	public AvaliacaoMediano(AvaliacaoHandler proximoHandler) {

		this.proximoHandler = proximoHandler;

		this.avaliacao = Avaliacao.MEDIANO;
