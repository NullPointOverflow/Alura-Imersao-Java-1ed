...
public class ClassificacaoSegundo implements ClassificacaoHandler, CalculadorDeImagem {
	...
	public ClassificacaoSegundo(ClassificacaoHandler proximoHandler) {

		this.proximoHandler = proximoHandler;

		this.classificacao = Classificacao.SEGUNDO;
