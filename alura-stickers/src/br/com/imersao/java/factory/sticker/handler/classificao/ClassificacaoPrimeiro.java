...
public class ClassificacaoPrimeiro implements ClassificacaoHandler, CalculadorDeImagem {
	...
	public ClassificacaoPrimeiro(ClassificacaoHandler proximoHandler) {

		this.proximoHandler = proximoHandler;

		this.classificacao = Classificacao.PRIMEIRO;
