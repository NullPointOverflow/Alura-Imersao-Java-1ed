...
public class ClassificacaoTerceiro implements ClassificacaoHandler, CalculadorDeImagem {

	private final ClassificacaoHandler proximoHandler;
	...
	public ClassificacaoTerceiro(ClassificacaoHandler proximoHandler) {

		this.proximoHandler = proximoHandler;

		this.classificacao = Classificacao.TERCEIRO;
	...
	public void manipular(FonteFactory geradorDeFonte, BufferedImage imagem, Conteudo conteudo, int colocacao) {
		...
		if (!(this.deveManipular(colocacao))) {
			...
			this.proximoHandler.manipular(geradorDeFonte, imagem, conteudo, colocacao);
